        ...
        <div class="card-body">
            ...
            <form action="{{ route('barang_keluars.update', $barangKeluar->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal" id="tanggal" class="form-control" value="{{ $barangKeluar->tanggal }}" required>
                </div>

                <button type="submit" class="btn btn-primary">💾 Simpan Perubahan</button>
                <a href="{{ route('barang_keluars.index') }}" class="btn btn-secondary">↩ Kembali</a>
            </form>
        </div>
    </div>
</div>
